# -*- coding: utf-8 -*-
"""
Created on Wed Apr  9 23:43:50 2025
...
from Network_CNN import AUTOMAP_BASIC_2
...
class Config:
    fc_input_dim = 256*1024
    fc_hidden_dim = 8*256
    fc_output_dim = 256*256
    im_h = 256
    im_w = 256
...
model_dir = "G:\\PhD\\Third_year\\Sinogram_recon\\hyper\\test_6_py"
...
noisy_test_path = r'G:\PhD\Third_year\Sinogram_recon\hyper\test_6_py\recon'
...
# ======================= Model Setup =======================
config = Config()
model = AUTOMAP_BASIC_2(config).to(device)
model.activation = model.get_activation_function(activation)
